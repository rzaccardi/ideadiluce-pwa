...
export const messages: Record<MessageKey, string> = {
  ...
  'nav.lights': 'Lumières',
  'nav.lightsOn': 'Allumer les lumières',
  'nav.lightsOff': 'Éteindre les lumières',
  ...
  'privacy.storage.title': 'Stockage local (localStorage)',
  'privacy.storage.intro':
    'Outre les cookies, le Site utilise le HTML5 localStorage sur l’appareil pour des fonctions nécessaires ou de préférence. Il n’est pas utilisé à des fins publicitaires. La liste Cookiebot ci-dessous inclut aussi les cookies et le stockage tiers détectés sur le domaine.',
  'privacy.storage.col.name': 'Nom',
  'privacy.storage.col.type': 'Type',
  'privacy.storage.col.duration': 'Durée',
  'privacy.storage.col.purpose': 'Finalité',
  'privacy.storage.col.category': 'Catégorie',
  'privacy.storage.type.localStorage': 'HTML5 Local Storage',
  'privacy.storage.duration.persistent': 'Persistant',
  'privacy.storage.duration.untilLogout': 'Jusqu’à la déconnexion',
  'privacy.storage.category.necessary': 'Nécessaires',
  'privacy.storage.category.preferences': 'Préférences',
  'privacy.storage.cartMirror.purpose':
    'Conserve la référence au panier (identifiant et expiration de réservation) entre les visites.',
  'privacy.storage.authSession.purpose': 'Conserve l’état de connexion au compte entre les visites.',
  'privacy.storage.searchRecent.purpose': 'Enregistre les recherches récentes du catalogue pour la langue active.',
  'privacy.storage.lights.purpose': 'Mémorise si les photos produit sont affichées allumées ou éteintes.',
  ...
  'productNotFound.contactTitle': 'Besoin d\'aide ?',
  'productNotFound.contactBody':
    'Écrivez-nous ou appelez-nous : nous vous aidons à identifier le produit et à trouver la bonne solution.',
  'productNotFound.contactCta': 'Voir les contacts',
  'chiSiamo.companyData': 'Coordonnées',
  'chiSiamo.hours': 'Horaires',
  'chiSiamo.writeUs': 'Nous écrire',
  'chiSiamo.whatsapp': 'WhatsApp',
  'chiSiamo.heroImageAlt': 'Idea di Luce · Rome',
  'chiSiamo.mapAlt': 'Plan / siège Idea di Luce',
  ...
  'product.notAvailable': 'Produit plus disponible',
  ...
  'product.docs.title': 'Documents et fiches techniques',
  'product.docs.datasheet': 'Fiche technique',
  'product.docs.euSheet': 'Fiche produit UE',
  'product.docs.ce': 'Déclaration CE',
  'product.docs.instructions': 'Instructions',
  'product.docs.download': 'Télécharger',
  ...
  'product.designRelated.designerEyebrow': 'LE DESIGNER',
  'product.designRelated.designerTitle': 'Autres projets de {name}',
  'product.designRelated.similarEyebrow': 'SIMILAIRES',
  'product.designRelated.similarTitle': "D'autres icônes à découvrir",
  'product.designRelated.seeAll': 'Tout voir →',
  'product.accessories.title': 'Accessoires compatibles',
  'product.accessories.subtitle': 'Ampoules et accessoires recommandés dans Odoo pour ce produit.',
  'product.accessories.compactTitle': 'Compléter avec des accessoires',
  'product.accessories.sectionHeading': 'Compléter le projet',
  'product.accessories.addOn': 'Ajouter l’accessoire',
  'product.accessories.addWithProduct': 'Ajouter ensemble',
  'product.accessories.selectedCount': '{count} accessoires sélectionnés',
  'product.accessories.viewProduct': 'Voir la fiche',
  'product.accessories.unavailableLink': 'Fiche non disponible',
  'product.accessories.includedTotal': '{count} accessoires inclus · Total {total}',
  'product.accessories.priceIncludes': 'Produit {product} + accessoires {accessories}',
  'product.suggested.oosBanner': 'Indisponible. Alternatives suggérées :',
  'product.suggested.title': 'Vous aimerez aussi',
  'product.compatibleSources.title': 'Sources compatibles',
  'product.compatibleSources.subtitle': 'Produits avec lesquels cette pièce est compatible.',
  'product.grid.empty': 'Aucun produit dans la liste.',
  'product.card.noImage': 'Pas d\'image',
  'product.price.vatIncluded': 'TVA comprise',
  'product.price.vatExcluded': 'TVA exclue',
  ...
  'cart.checkoutCta': 'Procéder au paiement',
  ...
  'walletQuickPay.openCheckout': 'Procéder au paiement',
  ...
  'checkout.summary.shippingFree': 'Gratuite',
  ...
  'checkout.summary.trust.supportTitle': 'Assistance réelle',
  'checkout.summary.trust.supportSubtitle': 'Avant et après la commande',
  ...
  'checkout.shipping.freeShippingLockedHint':
    'Vous bénéficiez de la livraison gratuite : vous pouvez choisir la livraison gratuite ou le retrait en magasin.',
  ...
  'thankYou.support.body':
    'Notre équipe vous aide sur câblage, compatibilité et installation. Contactez-nous à tout moment.',
  ...
  'account.invoices.state.posted': 'Confirmé',
  'account.invoices.state.draft': 'Brouillon',
  'account.invoices.state.cancel': 'Annulé',
  'account.invoices.payment.paid': 'Payé',
  'account.invoices.payment.unpaid': 'Non payé',
  ...
  'orders.return.title': 'Droit de rétractation et retours',
  'orders.return.description':
    'Vous pouvez demander un retour dans les 14 jours suivant la réception des produits. La demande est transmise à l’administration : vous recevrez sous peu les indications sur la procédure à suivre.',
  'orders.return.button': 'Demander un retour',
  'orders.return.submit': 'Envoyer la demande de retour',
  'orders.return.submitting': 'Envoi en cours…',
  'orders.return.notesLabel': 'Motif (facultatif)',
  'orders.return.notesPlaceholder':
    'Indiquez les articles à retourner et, si vous le souhaitez, le motif.',
  'orders.return.successTitle': 'Demande de retour envoyée',
  'orders.return.successBody':
    'Nous vous avons envoyé un e-mail de confirmation. Vous recevrez sous peu les indications sur la procédure à suivre pour effectuer le retour.',
  'orders.return.alreadyRequested': 'Demande déjà envoyée',
  'orders.return.toastSuccess': 'Demande de retour envoyée. Consultez votre e-mail.',
  'orders.return.toastAlready': 'Vous avez déjà envoyé une demande de retour pour cette commande.',
  'orders.return.legalNote':
    'Le droit de rétractation ne s’applique pas aux produits sur mesure, personnalisés ou qui, par nature, ne peuvent pas être renvoyés.',
  'orders.return.expired':
    'Plus de 14 jours se sont écoulés depuis la livraison. Il n’est plus possible de demander un retour pour cette commande.',
  'orders.return.expiredTitle': 'Délai de retour expiré',
  'orders.return.expiredButton': 'Délai expiré',
  'orders.shipment.title': 'Expédition et colis',
  'orders.shipment.carrier': 'Transporteur',
  'orders.shipment.tracking': 'Suivi',
  'orders.shipment.location': 'Dernière position',
  'orders.shipment.eta': 'Livraison estimée',
  'orders.shipment.deliveredAt': 'Livré le',
  ...
  'orderStatus.shipment_exception': 'Anomalie d’expédition',
  ...
  'theme.switcher.title': 'Thème noir ou sombre',
  ...
  'checkout.address.province': 'Province',
  ...
  'checkout.address.phoneOptional': 'Téléphone',
  ...
  'checkout.loading.accountLogin': 'Récupération des données du compte…',
  ...
  'legacySite.notice.message':
    'Vous êtes sur notre nouveau site. Si quelque chose ne fonctionne pas ou si vous ne parvenez pas à finaliser la commande, vous pouvez continuer sur l’ancien site.',
  'legacySite.notice.cta': 'Ouvrir l’ancien site',
  'legacySite.checkout.hint':
    'Impossible de finaliser la commande ? Vous pouvez continuer sur l’ancien site pendant que nous corrigeons le problème.',
  'legacySite.footer.link': 'Un souci avec le nouveau site ? Continuez sur old.ideadiluce.it',
  ...
  'product.meta.eanCopied': 'Copié',
  'product.meta.eanCopyAria': 'Copier l’EAN {ean}',
  'product.meta.eanCopyFailed': 'Impossible de copier le code EAN',
  'product.meta.eanBarcodeAria': 'Code-barres EAN {ean}',
  'product.meta.eanDownloadPng': 'Télécharger PNG',
  'product.meta.eanDownloadPdf': 'Télécharger PDF',
  'product.meta.eanDownloadSvg': 'Télécharger SVG',
  'product.meta.eanDownloadFailed': 'Impossible de télécharger le code-barres',
  'product.meta.eanCopyHint': 'Cliquer pour copier',
  ...
  'validation.invalidPostalCode': 'Code postal invalide.',
  'validation.invalidProvince': 'Province invalide.',
  'validation.invalidPhone': 'Numéro de téléphone invalide.',
  'validation.invalidCountry': 'Code pays invalide.',
  'validation.required': 'Champ obligatoire.',
  'validation.tooShort': 'Valeur trop courte.',
  'validation.tooLong': 'Valeur trop longue.',
  'validation.invalidEmail': 'Adresse e-mail non valide.',
  'validation.invalid': 'Données non valides.',
  'validation.emailRequired': 'L’e-mail est obligatoire.',
  'validation.addressesRequired':
    'Les adresses de facturation et de livraison sont obligatoires.',
  'validation.paymentMethodRequired': 'Le mode de paiement est obligatoire.',
  'validation.companyNameRequired': 'La raison sociale est obligatoire.',
  'validation.companyNameRequiredBusiness':
    'La raison sociale est obligatoire pour les commandes professionnelles.',
  'validation.vatRequired': 'Le numéro de TVA est obligatoire.',
  'validation.vatRequiredBusiness':
  ...
  'validation.fiscalCodeRequired': 'Le code fiscal est obligatoire.',
  'validation.fiscalCodeLength': 'Le code fiscal doit contenir 16 caractères.',
  'validation.fiscalCodeFormat': 'Format de code fiscal invalide.',
  'validation.fiscalCodeInvalid': 'Code fiscal invalide.',
  'validation.vatDigits': 'Le numéro de TVA doit comporter 11 chiffres.',
  'validation.vatChecksum': 'Clé de contrôle TVA invalide.',
  'validation.vatFormatInvalid': 'Format de numéro de TVA invalide.',
  'validation.vatInvalid': 'Numéro de TVA invalide.',
}
