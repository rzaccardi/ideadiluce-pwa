...
export const messages: Record<MessageKey, string> = {
  ...
  'nav.logout': 'Esci',
  'nav.lights': 'Luci',
  'nav.lightsOn': 'Accendi le luci',
  'nav.lightsOff': 'Spegni le luci',
  ...
  'privacy.storage.title': 'Archiviazione locale (localStorage)',
  'privacy.storage.intro':
    'Oltre ai cookie, il Sito usa HTML5 localStorage sul dispositivo per funzioni necessarie o di preferenza. Non è usato per pubblicità. L’elenco Cookiebot sotto include anche cookie e storage di terze parti rilevati sul dominio.',
  'privacy.storage.col.name': 'Nome',
  'privacy.storage.col.type': 'Tipo',
  'privacy.storage.col.duration': 'Durata',
  'privacy.storage.col.purpose': 'Finalità',
  'privacy.storage.col.category': 'Categoria',
  'privacy.storage.type.localStorage': 'HTML5 Local Storage',
  'privacy.storage.duration.persistent': 'Persistente',
  'privacy.storage.duration.untilLogout': 'Fino al logout',
  'privacy.storage.category.necessary': 'Necessari',
  'privacy.storage.category.preferences': 'Preferenze',
  'privacy.storage.cartMirror.purpose':
    'Mantiene il riferimento al carrello (identificativo e scadenza prenotazione) tra le visite.',
  'privacy.storage.authSession.purpose': 'Mantiene lo stato di accesso all’account tra le visite.',
  'privacy.storage.searchRecent.purpose': 'Salva le ricerche recenti nel catalogo per la lingua in uso.',
  'privacy.storage.lights.purpose': 'Memorizza se le foto prodotto sono mostrate accese o spente.',
  ...
  'catalog.degradedBanner':
    'Catalogo in modalità ridotta: disponibilità e prezzi potrebbero non essere aggiornati. Puoi comunque ordinare.',
  ...
  'product.degradedBanner':
    'Scheda da cache locale: disponibilità da confermare. Puoi comunque procedere all’acquisto.',
  ...
  'product.docs.title': 'Documenti e schede tecniche',
  'product.docs.datasheet': 'Scheda tecnica',
  ...
  'product.accessories.sectionHeading': 'Completa il progetto',
  'product.accessories.addOn': 'Aggiungi accessorio',
  ...
  'product.suggested.oosBanner': 'Non disponibile. Alternative consigliate:',
  'product.suggested.title': 'Ti potrebbe interessare',
  'product.compatibleSources.title': 'Fonti compatibili',
  'product.compatibleSources.subtitle': 'Prodotti da cui questo ricambio è compatibile.',
  'product.grid.empty': 'Nessun prodotto in elenco.',
  'product.card.noImage': 'Nessuna immagine',
  'product.price.vatIncluded': 'IVA inclusa',
  'product.price.vatExcluded': 'IVA esclusa',
  ...
  'product.meta.eanCopyAria': 'Copia EAN {ean}',
  ...
  'cart.checkoutCta': 'Procedi con il pagamento',
  'cart.remove': 'Rimuovi',
  ...
  'walletQuickPay.openCheckout': 'Procedi con il pagamento',
  ...
  'checkout.shipping.freeShippingLockedHint':
    'Hai diritto alla spedizione gratuita: puoi scegliere la consegna gratuita o il ritiro in negozio.',
  ...
  'checkout.shipping.savedAddressesHint': 'Scegli un indirizzo di spedizione già collegato al tuo account.',
  'checkout.shipping.useOtherAddress': 'Usa un altro indirizzo',
  ...
  'checkout.loading.accountLogin': 'Recupero dati account…',
  ...
  'checkout.address.phoneOptional': 'Telefono',
  ...
  'account.addresses.description':
    'Indirizzi di spedizione del tuo account. Ogni destinazione è collegata a un contatto di consegna in Odoo.',
  'account.addresses.empty': 'Nessun indirizzo di spedizione salvato.',
  'account.addresses.add': 'Aggiungi indirizzo',
  'account.addresses.addTitle': 'Nuovo indirizzo di spedizione',
  'account.addresses.edit': 'Modifica',
  'account.addresses.editTitle': 'Modifica indirizzo',
  'account.addresses.delete': 'Elimina',
  'account.addresses.deleteConfirmTitle': 'Eliminare questo indirizzo?',
  ...
  'account.invoices.state.posted': 'Confermato',
  'account.invoices.state.draft': 'Bozza',
  'account.invoices.state.cancel': 'Annullato',
  'account.invoices.payment.paid': 'Pagato',
  'account.invoices.payment.unpaid': 'Non Pagato',
  ...
  'orders.return.title': 'Diritto di recesso e reso',
  'orders.return.description':
    'Puoi richiedere il reso entro 14 giorni dal ricevimento dei prodotti. La richiesta viene inviata all’amministrazione: a breve riceverai indicazioni sulle procedure da seguire.',
  'orders.return.button': 'Richiedi reso',
  'orders.return.submit': 'Invia richiesta di reso',
  'orders.return.submitting': 'Invio in corso…',
  'orders.return.notesLabel': 'Motivo (facoltativo)',
  'orders.return.notesPlaceholder':
    'Indica gli articoli da restituire e, se vuoi, il motivo del reso.',
  'orders.return.successTitle': 'Richiesta di reso inviata',
  'orders.return.successBody':
    'Ti abbiamo inviato un’email di conferma. A breve riceverai indicazioni sulle procedure da seguire per effettuare il reso.',
  'orders.return.alreadyRequested': 'Richiesta già inviata',
  'orders.return.toastSuccess': 'Richiesta di reso inviata. Controlla la tua email.',
  'orders.return.toastAlready': 'Hai già inviato una richiesta di reso per questo ordine.',
  'orders.return.legalNote':
    'Il diritto di recesso non si applica a prodotti su misura, personalizzati o che per loro natura non possono essere rispediti.',
  'orders.return.expired':
    'Sono passati più di 14 giorni dalla consegna. Non è più possibile avviare il reso da quest’ordine.',
  'orders.return.expiredTitle': 'Termine di reso scaduto',
  'orders.return.expiredButton': 'Termine scaduto',
  'orders.shipment.title': 'Spedizione e pacco',
  'orders.shipment.carrier': 'Corriere',
  'orders.shipment.tracking': 'Tracking',
  'orders.shipment.location': 'Ultima posizione',
  'orders.shipment.eta': 'Consegna stimata',
  'orders.shipment.deliveredAt': 'Consegnato il',
  ...
  'orderStatus.out_for_delivery': 'In consegna',
  'orderStatus.delivered': 'Consegnato',
  'orderStatus.shipment_exception': 'Anomalia di spedizione',
  ...
  'legacySite.notice.message':
    'Stai usando il nuovo sito. Se qualcosa non funziona o non riesci a completare l’ordine, puoi continuare sul sito precedente.',
  'legacySite.notice.cta': 'Apri il sito precedente',
  'legacySite.checkout.hint':
    'Non riesci a completare l’ordine? Puoi procedere sul sito precedente mentre sistemiamo questo.',
  'legacySite.footer.link': 'Problemi con il nuovo sito? Continua su old.ideadiluce.it',
  ...
  'validation.invalidPostalCode': 'CAP non valido.',
  'validation.invalidProvince': 'Provincia non valida.',
  'validation.invalidPhone': 'Numero di telefono non valido.',
  'validation.invalidCountry': 'Codice paese non valido.',
  'validation.required': 'Campo obbligatorio.',
  'validation.tooShort': 'Valore troppo corto.',
  'validation.tooLong': 'Valore troppo lungo.',
  'validation.invalidEmail': 'Email non valida.',
  'validation.invalid': 'Dati non validi.',
  'validation.emailRequired': 'Email obbligatoria.',
  'validation.addressesRequired': 'Indirizzi di fatturazione e spedizione obbligatori.',
  'validation.paymentMethodRequired': 'Metodo di pagamento obbligatorio.',
  'validation.companyNameRequired': 'Ragione sociale obbligatoria.',
  'validation.companyNameRequiredBusiness': 'Ragione sociale obbligatoria per ordini business.',
  'validation.vatRequired': 'Partita IVA obbligatoria.',
  'validation.vatRequiredBusiness': 'Partita IVA obbligatoria per ordini business.',
  'validation.pecOrSdiRequired': 'Inserire almeno PEC o codice destinatario SDI.',
  'validation.fiscalCodeRequired': 'Codice fiscale obbligatorio.',
  'validation.fiscalCodeLength': 'Il codice fiscale deve avere 16 caratteri.',
  'validation.fiscalCodeFormat': 'Formato codice fiscale non valido.',
  'validation.fiscalCodeInvalid': 'Codice fiscale non valido.',
  'validation.vatDigits': 'La partita IVA deve avere 11 cifre.',
  'validation.vatChecksum': 'Cifra di controllo partita IVA non valida.',
  'validation.vatFormatInvalid': 'Formato partita IVA non valido.',
  'validation.vatInvalid': 'Partita IVA non valida.',
