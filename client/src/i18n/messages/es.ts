...
export const messages: Record<MessageKey, string> = {
  ...
  'nav.lights': 'Luces',
  'nav.lightsOn': 'Encender las luces',
  'nav.lightsOff': 'Apagar las luces',
  ...
  'privacy.storage.title': 'Almacenamiento local (localStorage)',
  'privacy.storage.intro':
    'Además de las cookies, el Sitio usa HTML5 localStorage en el dispositivo para funciones necesarias o de preferencia. No se usa para publicidad. La lista de Cookiebot incluye también cookies y almacenamiento de terceros detectados en el dominio.',
  'privacy.storage.col.name': 'Nombre',
  'privacy.storage.col.type': 'Tipo',
  'privacy.storage.col.duration': 'Duración',
  'privacy.storage.col.purpose': 'Finalidad',
  'privacy.storage.col.category': 'Categoría',
  'privacy.storage.type.localStorage': 'HTML5 Local Storage',
  'privacy.storage.duration.persistent': 'Persistente',
  'privacy.storage.duration.untilLogout': 'Hasta el cierre de sesión',
  'privacy.storage.category.necessary': 'Necesarios',
  'privacy.storage.category.preferences': 'Preferencias',
  'privacy.storage.cartMirror.purpose':
    'Mantiene la referencia al carrito (identificador y caducidad de la reserva) entre visitas.',
  'privacy.storage.authSession.purpose': 'Mantiene el estado de acceso a la cuenta entre visitas.',
  'privacy.storage.searchRecent.purpose': 'Guarda las búsquedas recientes del catálogo para el idioma activo.',
  'privacy.storage.lights.purpose': 'Recuerda si las fotos de producto se muestran encendidas o apagadas.',
  ...
  'productNotFound.contactTitle': '¿Necesitas ayuda?',
  'productNotFound.contactBody':
    'Escríbenos o llámanos: te ayudamos a identificar el producto y a encontrar la solución adecuada.',
  'productNotFound.contactCta': 'Ir a contactos',
  ...
  'chiSiamo.mapAlt': 'Mapa / sede Idea di Luce',
  ...
  'product.docs.title': 'Documentos y fichas técnicas',
  'product.docs.datasheet': 'Ficha técnica',
  'product.docs.euSheet': 'Ficha de producto UE',
  'product.docs.ce': 'Declaración CE',
  'product.docs.instructions': 'Instrucciones',
  'product.docs.download': 'Descargar',
  ...
  'product.designRelated.designerEyebrow': 'EL DISEÑADOR',
  'product.designRelated.designerTitle': 'Otros proyectos de {name}',
  'product.designRelated.similarEyebrow': 'SIMILARES',
  'product.designRelated.similarTitle': 'Más iconos por descubrir',
  'product.designRelated.seeAll': 'Ver todos →',
  'product.accessories.title': 'Accesorios compatibles',
  'product.accessories.subtitle': 'Bombillas y accesorios recomendados en Odoo para este producto.',
  'product.accessories.compactTitle': 'Completa con accesorios',
  'product.accessories.sectionHeading': 'Completa el proyecto',
  'product.accessories.addOn': 'Añadir accesorio',
  'product.accessories.addWithProduct': 'Añadir juntos',
  'product.accessories.selectedCount': '{count} accesorios seleccionados',
  'product.accessories.viewProduct': 'Ver ficha',
  'product.accessories.unavailableLink': 'Ficha no disponible',
  'product.accessories.includedTotal': '{count} accesorios incluidos · Total {total}',
  'product.accessories.priceIncludes': 'Producto {product} + accesorios {accessories}',
  'product.suggested.oosBanner': 'No disponible. Alternativas sugeridas:',
  'product.suggested.title': 'También te puede interesar',
  'product.compatibleSources.title': 'Fuentes compatibles',
  'product.compatibleSources.subtitle': 'Productos con los que este recambio es compatible.',
  'product.grid.empty': 'No hay productos en la lista.',
  'product.card.noImage': 'Sin imagen',
  'product.price.vatIncluded': 'IVA incluida',
  'product.price.vatExcluded': 'IVA excluida',
  ...
  'cart.checkoutCta': 'Continuar con el pago',
  ...
  'walletQuickPay.openCheckout': 'Continuar con el pago',
  ...
  'checkout.summary.shippingFree': 'Gratuita',
  ...
  'checkout.summary.trust.supportTitle': 'Asistencia real',
  'checkout.summary.trust.supportSubtitle': 'Antes y después del pedido',
  ...
  'checkout.shipping.freeShippingLockedHint':
    'Tienes envío gratuito: puedes elegir entrega gratuita o recogida en tienda.',
  ...
  'thankYou.support.body':
    'Nuestro equipo te ayuda con conexiones, compatibilidad e instalación. Escríbenos cuando quieras.',
  ...
  'account.invoices.state.posted': 'Confirmado',
  'account.invoices.state.draft': 'Borrador',
  'account.invoices.state.cancel': 'Cancelado',
  'account.invoices.payment.paid': 'Pagado',
  'account.invoices.payment.unpaid': 'No pagado',
  ...
  'orders.return.title': 'Derecho de desistimiento y devolución',
  'orders.return.description':
    'Puedes solicitar la devolución en un plazo de 14 días desde la recepción de los productos. La solicitud se envía a administración: en breve recibirás indicaciones sobre el procedimiento a seguir.',
  'orders.return.button': 'Solicitar devolución',
  'orders.return.submit': 'Enviar solicitud de devolución',
  'orders.return.submitting': 'Enviando…',
  'orders.return.notesLabel': 'Motivo (opcional)',
  'orders.return.notesPlaceholder':
    'Indica los artículos que quieres devolver y, si lo deseas, el motivo.',
  'orders.return.successTitle': 'Solicitud de devolución enviada',
  'orders.return.successBody':
    'Te hemos enviado un email de confirmación. En breve recibirás indicaciones sobre el procedimiento a seguir para efectuar la devolución.',
  'orders.return.alreadyRequested': 'Solicitud ya enviada',
  'orders.return.toastSuccess': 'Solicitud de devolución enviada. Revisa tu email.',
  'orders.return.toastAlready': 'Ya has enviado una solicitud de devolución para este pedido.',
  'orders.return.legalNote':
    'El derecho de desistimiento no se aplica a productos a medida, personalizados o que por su naturaleza no pueden reenviarse.',
  'orders.return.expired':
    'Han pasado más de 14 días desde la entrega. Ya no es posible iniciar la devolución de este pedido.',
  'orders.return.expiredTitle': 'Plazo de devolución vencido',
  'orders.return.expiredButton': 'Plazo vencido',
  'orders.shipment.title': 'Envío y paquete',
  'orders.shipment.carrier': 'Transportista',
  'orders.shipment.tracking': 'Seguimiento',
  'orders.shipment.location': 'Última ubicación',
  'orders.shipment.eta': 'Entrega estimada',
  'orders.shipment.deliveredAt': 'Entregado el',
  ...
  'orderStatus.shipment_exception': 'Incidencia de envío',
  ...
  'theme.switcher.title': 'Tema negro u oscuro',
  ...
  'checkout.address.phoneOptional': 'Teléfono',
  ...
  'checkout.loading.accountLogin': 'Recuperando datos de la cuenta…',
  ...
  'legacySite.notice.message':
    'Estás en nuestro nuevo sitio. Si algo no funciona o no puedes completar el pedido, puedes continuar en el sitio anterior.',
  'legacySite.notice.cta': 'Abrir el sitio anterior',
  'legacySite.checkout.hint':
    '¿No puedes completar el pedido? Puedes continuar en el sitio anterior mientras lo solucionamos.',
  'legacySite.footer.link': '¿Problemas con el nuevo sitio? Continúa en old.ideadiluce.it',
  ...
  'product.meta.eanCopied': 'Copiado',
  'product.meta.eanCopyAria': 'Copiar EAN {ean}',
  'product.meta.eanCopyFailed': 'No se pudo copiar el código EAN',
  'product.meta.eanBarcodeAria': 'Código de barras EAN {ean}',
  'product.meta.eanDownloadPng': 'Descargar PNG',
  'product.meta.eanDownloadPdf': 'Descargar PDF',
  'product.meta.eanDownloadSvg': 'Descargar SVG',
  'product.meta.eanDownloadFailed': 'No se pudo descargar el código de barras',
  'product.meta.eanCopyHint': 'Haz clic para copiar',
  ...
  'validation.streetNumberOrSnc': 'Introduce el número o selecciona «Sin número».',
  'validation.invalidPostalCode': 'Código postal no válido.',
  'validation.invalidProvince': 'Provincia no válida.',
  'validation.invalidPhone': 'Número de teléfono no válido.',
  'validation.invalidCountry': 'Código de país no válido.',
  'validation.required': 'Campo obligatorio.',
  'validation.tooShort': 'El valor es demasiado corto.',
  'validation.tooLong': 'El valor es demasiado largo.',
  'validation.invalidEmail': 'Email no válida.',
  'validation.invalid': 'Datos no válidos.',
  'validation.emailRequired': 'El email es obligatorio.',
  'validation.addressesRequired': 'Las direcciones de facturación y envío son obligatorias.',
  'validation.paymentMethodRequired': 'El método de pago es obligatorio.',
  'validation.companyNameRequired': 'La razón social es obligatoria.',
  'validation.companyNameRequiredBusiness': 'La razón social es obligatoria para pedidos de empresa.',
  'validation.vatRequired': 'El NIF/IVA es obligatorio.',
  'validation.vatRequiredBusiness': 'El NIF/IVA es obligatorio para pedidos de empresa.',
  'validation.pecOrSdiRequired': 'Indica al menos un email PEC o un código destinatario SDI.',
  'validation.fiscalCodeRequired': 'El código fiscal es obligatorio.',
  'validation.fiscalCodeLength': 'El código fiscal debe tener 16 caracteres.',
  'validation.fiscalCodeFormat': 'Formato de código fiscal no válido.',
  'validation.fiscalCodeInvalid': 'Código fiscal no válido.',
  'validation.vatDigits': 'El NIF/IVA debe tener 11 dígitos.',
  'validation.vatChecksum': 'Dígito de control del NIF/IVA no válido.',
  'validation.vatFormatInvalid': 'Formato de NIF/IVA no válido.',
  'validation.vatInvalid': 'NIF/IVA no válido.',
}
