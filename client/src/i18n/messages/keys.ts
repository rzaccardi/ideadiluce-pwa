export type MessageKey =
  ...
  | 'privacy.storage.col.name'
  | 'privacy.storage.col.type'
  | 'privacy.storage.col.duration'
  | 'privacy.storage.col.purpose'
  | 'privacy.storage.col.category'
  | 'privacy.storage.type.localStorage'
  | 'privacy.storage.duration.persistent'
  | 'privacy.storage.duration.untilLogout'
  | 'privacy.storage.category.necessary'
  | 'privacy.storage.category.preferences'
  | 'privacy.storage.cartMirror.purpose'
  | 'privacy.storage.authSession.purpose'
  | 'privacy.storage.searchRecent.purpose'
  | 'privacy.storage.lights.purpose'
  | 'error.genericTitle'
  | 'notFound.metaTitle'
  | 'notFound.eyebrow'
  | 'notFound.title'
  ...
  | 'product.docs.title'
  | 'product.docs.datasheet'
  | 'product.docs.euSheet'
  | 'product.docs.ce'
  ...
  | 'product.designRelated.designerEyebrow'
  | 'product.designRelated.designerTitle'
  | 'product.designRelated.similarEyebrow'
  | 'product.designRelated.similarTitle'
  | 'product.designRelated.seeAll'
  | 'product.accessories.title'
  | 'product.accessories.subtitle'
  | 'product.accessories.compactTitle'
  | 'product.accessories.sectionHeading'
  | 'product.accessories.addOn'
  | 'product.accessories.addWithProduct'
  | 'product.accessories.selectedCount'
  | 'product.accessories.viewProduct'
  | 'product.accessories.unavailableLink'
  | 'product.accessories.includedTotal'
  | 'product.accessories.priceIncludes'
  | 'product.suggested.oosBanner'
  | 'product.suggested.title'
  | 'product.compatibleSources.title'
  | 'product.compatibleSources.subtitle'
  | 'product.grid.empty'
  | 'product.card.noImage'
  | 'product.price.vatIncluded'
  | 'product.price.vatExcluded'
  | 'product.quantityLabel'
  | 'product.variantLabel'
  | 'product.variantSoldOut'
  | 'product.meta.sku'
  | 'product.meta.ean'
  | 'product.meta.eanCopyAria'
  | 'product.meta.eanCopyHint'
  | 'product.meta.eanCopied'
  | 'product.meta.eanCopyFailed'
  | 'product.meta.eanBarcodeAria'
  | 'product.meta.eanDownloadPng'
  | 'product.meta.eanDownloadPdf'
  | 'product.meta.eanDownloadSvg'
  | 'product.meta.eanDownloadFailed'
  | 'product.meta.brand'
  ...
  | 'checkout.shipping.savedAddressesHint'
  | 'checkout.shipping.useOtherAddress'
  ...
  | 'account.addresses.addTitle'
  | 'account.addresses.edit'
  | 'account.addresses.editTitle'
  ...
  | 'account.invoices.state.posted'
  | 'account.invoices.state.draft'
  | 'account.invoices.state.cancel'
  | 'account.invoices.payment.paid'
  | 'account.invoices.payment.unpaid'
  ...
  | 'orders.return.button'
  | 'orders.return.submit'
  | 'orders.return.submitting'
  | 'orders.return.notesLabel'
  | 'orders.return.notesPlaceholder'
  | 'orders.return.successTitle'
  | 'orders.return.successBody'
  | 'orders.return.alreadyRequested'
  | 'orders.return.toastSuccess'
  | 'orders.return.toastAlready'
  | 'orders.return.legalNote'
  | 'orders.return.expired'
  | 'orders.return.expiredTitle'
  | 'orders.return.expiredButton'
  | 'orders.shipment.title'
  | 'orders.shipment.carrier'
  | 'orders.shipment.tracking'
  | 'orders.shipment.location'
  | 'orders.shipment.eta'
  | 'orders.shipment.deliveredAt'
  ...
  | 'legacySite.notice.cta'
  | 'legacySite.checkout.hint'
  | 'legacySite.footer.link'
  | 'cart.floating.close'
  ...
  | 'validation.vatRequired'
  | 'validation.vatRequiredBusiness'
  | 'validation.pecOrSdiRequired'
  | 'validation.fiscalCodeRequired'
  | 'validation.fiscalCodeLength'
  | 'validation.fiscalCodeFormat'
  | 'validation.fiscalCodeInvalid'
  | 'validation.vatDigits'
  | 'validation.vatChecksum'
  | 'validation.vatFormatInvalid'
  | 'validation.vatInvalid'
