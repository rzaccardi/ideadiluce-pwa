...
export const messages: Record<MessageKey, string> = {
  ...
  'nav.logout': 'Abmelden',
  'nav.lights': 'Licht',
  'nav.lightsOn': 'Licht einschalten',
  'nav.lightsOff': 'Licht ausschalten',
  ...
  'privacy.storage.title': 'Lokaler Speicher (localStorage)',
  'privacy.storage.intro':
    'Neben Cookies verwendet die Website HTML5-localStorage auf dem Gerät für notwendige oder Präferenzfunktionen. Es wird nicht für Werbung verwendet. Die Cookiebot-Liste unten enthält auch Drittanbieter-Cookies und Speicher, die auf der Domain erkannt wurden.',
  'privacy.storage.col.name': 'Name',
  'privacy.storage.col.type': 'Typ',
  'privacy.storage.col.duration': 'Dauer',
  'privacy.storage.col.purpose': 'Zweck',
  'privacy.storage.col.category': 'Kategorie',
  'privacy.storage.type.localStorage': 'HTML5 Local Storage',
  'privacy.storage.duration.persistent': 'Dauerhaft',
  'privacy.storage.duration.untilLogout': 'Bis zur Abmeldung',
  'privacy.storage.category.necessary': 'Notwendig',
  'privacy.storage.category.preferences': 'Präferenzen',
  'privacy.storage.cartMirror.purpose':
    'Speichert die Warenkorb-Referenz (ID und Reservierungsablauf) zwischen den Besuchen.',
  'privacy.storage.authSession.purpose': 'Speichert den Anmeldestatus des Kontos zwischen den Besuchen.',
  'privacy.storage.searchRecent.purpose': 'Speichert aktuelle Katalogsuchen für die aktive Sprache.',
  'privacy.storage.lights.purpose': 'Speichert, ob Produktfotos an oder aus angezeigt werden.',
  ...
  'productNotFound.contactTitle': 'Brauchst du Hilfe?',
  'productNotFound.contactBody':
    'Schreib uns oder ruf an: wir helfen dir, das Produkt zu identifizieren und die richtige Lösung zu finden.',
  'productNotFound.contactCta': 'Zu den Kontakten',
  'chiSiamo.companyData': 'Firmendaten',
  'chiSiamo.hours': 'Öffnungszeiten',
  'chiSiamo.writeUs': 'Schreib uns',
  'chiSiamo.whatsapp': 'WhatsApp',
  'chiSiamo.heroImageAlt': 'Idea di Luce · Rom',
  'chiSiamo.mapAlt': 'Karte / Sitz Idea di Luce',
  ...
  'product.docs.title': 'Dokumente und Datenblätter',
  'product.docs.datasheet': 'Datenblatt',
  'product.docs.euSheet': 'EU-Produktblatt',
  'product.docs.ce': 'CE-Konformitätserklärung',
  'product.docs.instructions': 'Anleitung',
  'product.docs.download': 'Download',
  ...
  'product.designRelated.designerEyebrow': 'DER DESIGNER',
  'product.designRelated.designerTitle': 'Weitere Entwürfe von {name}',
  'product.designRelated.similarEyebrow': 'ÄHNLICH',
  'product.designRelated.similarTitle': 'Weitere Ikonen entdecken',
  'product.designRelated.seeAll': 'Alle ansehen →',
  'product.accessories.title': 'Kompatibles Zubehör',
  'product.accessories.subtitle': 'Lampen und Zubehör, die in Odoo für dieses Produkt empfohlen werden.',
  'product.accessories.compactTitle': 'Mit Zubehör ergänzen',
  'product.accessories.sectionHeading': 'Das Set vervollständigen',
  'product.accessories.addOn': 'Zubehör hinzufügen',
  'product.accessories.addWithProduct': 'Zusammen hinzufügen',
  'product.accessories.selectedCount': '{count} Zubehörteile ausgewählt',
  'product.accessories.viewProduct': 'Produkt ansehen',
  'product.accessories.unavailableLink': 'Produktseite nicht verfügbar',
  'product.accessories.includedTotal': '{count} Zubehörteile inklusive · Gesamt {total}',
  'product.accessories.priceIncludes': 'Produkt {product} + Zubehör {accessories}',
  'product.suggested.oosBanner': 'Nicht verfügbar. Vorgeschlagene Alternativen:',
  'product.suggested.title': 'Das könnte Sie interessieren',
  'product.compatibleSources.title': 'Kompatible Quellen',
  'product.compatibleSources.subtitle': 'Produkte, zu denen dieses Ersatzteil passt.',
  'product.grid.empty': 'Keine Produkte in der Liste.',
  'product.card.noImage': 'Kein Bild',
  'product.price.vatIncluded': 'inkl. MwSt.',
  'product.price.vatExcluded': 'zzgl. MwSt.',
  ...
  'cart.checkoutCta': 'Weiter zur Zahlung',
  ...
  'walletQuickPay.openCheckout': 'Weiter zur Zahlung',
  ...
  'checkout.summary.shippingFree': 'Kostenlos',
  ...
  'checkout.summary.trust.supportTitle': 'Echte Beratung',
  'checkout.summary.trust.supportSubtitle': 'Vor und nach der Bestellung',
  ...
  'checkout.shipping.freeShippingLockedHint':
    'Sie haben Anspruch auf Gratisversand: Sie können kostenlose Lieferung oder Abholung im Geschäft wählen.',
  ...
  'thankYou.support.body':
    'Unser Team hilft bei Anschluss, Kompatibilität und Installation. Schreiben Sie uns jederzeit.',
  ...
  'account.invoices.state.posted': 'Bestätigt',
  'account.invoices.state.draft': 'Entwurf',
  'account.invoices.state.cancel': 'Storniert',
  'account.invoices.payment.paid': 'Bezahlt',
  'account.invoices.payment.unpaid': 'Nicht bezahlt',
  ...
  'orders.return.title': 'Widerrufsrecht und Rücksendung',
  'orders.return.description':
    'Sie können innerhalb von 14 Tagen nach Erhalt der Produkte eine Rücksendung beantragen. Die Anfrage geht an die Verwaltung: In Kürze erhalten Sie Hinweise zum weiteren Vorgehen.',
  'orders.return.button': 'Rücksendung beantragen',
  'orders.return.submit': 'Rücksendeanfrage senden',
  'orders.return.submitting': 'Wird gesendet…',
  'orders.return.notesLabel': 'Grund (optional)',
  'orders.return.notesPlaceholder':
    'Geben Sie die zurückzusendenden Artikel an und, falls gewünscht, den Grund.',
  'orders.return.successTitle': 'Rücksendeanfrage gesendet',
  'orders.return.successBody':
    'Wir haben Ihnen eine Bestätigungs-E-Mail gesendet. In Kürze erhalten Sie Hinweise zum weiteren Vorgehen, um die Rücksendung durchzuführen.',
  'orders.return.alreadyRequested': 'Anfrage bereits gesendet',
  'orders.return.toastSuccess': 'Rücksendeanfrage gesendet. Bitte prüfen Sie Ihre E-Mail.',
  'orders.return.toastAlready': 'Sie haben für diese Bestellung bereits eine Rücksendeanfrage gesendet.',
  'orders.return.legalNote':
    'Das Widerrufsrecht gilt nicht für maßgefertigte, personalisierte Produkte oder Artikel, die ihrer Natur nach nicht zurückgesendet werden können.',
  'orders.return.expired':
    'Seit der Zustellung sind mehr als 14 Tage vergangen. Eine Rücksendung kann für diese Bestellung nicht mehr gestartet werden.',
  'orders.return.expiredTitle': 'Rücksendefrist abgelaufen',
  'orders.return.expiredButton': 'Frist abgelaufen',
  'orders.shipment.title': 'Versand und Paket',
  'orders.shipment.carrier': 'Spediteur',
  'orders.shipment.tracking': 'Sendungsverfolgung',
  'orders.shipment.location': 'Letzter Standort',
  'orders.shipment.eta': 'Voraussichtliche Zustellung',
  'orders.shipment.deliveredAt': 'Zugestellt am',
  ...
  'orderStatus.out_for_delivery': 'In Zustellung',
  'orderStatus.delivered': 'Zugestellt',
  'orderStatus.shipment_exception': 'Lieferproblem',
  ...
  'theme.switcher.title': 'Schwarzes oder dunkles Design',
  ...
  'checkout.address.province': 'Provinz',
  ...
  'checkout.loading.accountLogin': 'Kontodaten werden geladen…',
  ...
  'legacySite.notice.message':
    'Sie nutzen unsere neue Website. Wenn etwas nicht funktioniert oder Sie die Bestellung nicht abschließen können, können Sie die vorherige Website weiter nutzen.',
  'legacySite.notice.cta': 'Vorherige Website öffnen',
  'legacySite.checkout.hint':
    'Bestellung nicht möglich? Sie können auf der vorherigen Website fortfahren, während wir das klären.',
  'legacySite.footer.link': 'Probleme mit der neuen Website? Weiter auf old.ideadiluce.it',
  ...
  'product.meta.eanCopied': 'Kopiert',
  'product.meta.eanCopyAria': 'EAN {ean} kopieren',
  'product.meta.eanCopyFailed': 'EAN-Code konnte nicht kopiert werden',
  'product.meta.eanBarcodeAria': 'EAN-Barcode {ean}',
  'product.meta.eanDownloadPng': 'PNG herunterladen',
  'product.meta.eanDownloadPdf': 'PDF herunterladen',
  'product.meta.eanDownloadSvg': 'SVG herunterladen',
  'product.meta.eanDownloadFailed': 'Barcode konnte nicht heruntergeladen werden',
  'product.meta.eanCopyHint': 'Zum Kopieren klicken',
  ...
  'validation.invalidPostalCode': 'Ungültige Postleitzahl.',
  'validation.invalidProvince': 'Ungültige Provinz.',
  'validation.invalidPhone': 'Ungültige Telefonnummer.',
  'validation.invalidCountry': 'Ungültiger Ländercode.',
  ...
  'validation.invalid': 'Ungültige Daten.',
  'validation.emailRequired': 'E-Mail ist erforderlich.',
  'validation.addressesRequired': 'Rechnungs- und Lieferadresse sind erforderlich.',
  'validation.paymentMethodRequired': 'Zahlungsmethode ist erforderlich.',
  'validation.companyNameRequired': 'Firmenname ist erforderlich.',
  'validation.companyNameRequiredBusiness': 'Firmenname ist für Geschäftskunden erforderlich.',
  'validation.vatRequired': 'USt-IdNr. ist erforderlich.',
  'validation.vatRequiredBusiness': 'USt-IdNr. ist für Geschäftskunden erforderlich.',
  'validation.pecOrSdiRequired':
    'Geben Sie mindestens eine PEC-Adresse oder einen SDI-Empfängercode an.',
  'validation.fiscalCodeRequired': 'Steuer-ID ist erforderlich.',
  'validation.fiscalCodeLength': 'Die Steuer-ID muss 16 Zeichen haben.',
  'validation.fiscalCodeFormat': 'Ungültiges Steuer-ID-Format.',
  'validation.fiscalCodeInvalid': 'Ungültige Steuer-ID.',
  'validation.vatDigits': 'Die USt-IdNr. muss 11 Ziffern haben.',
  'validation.vatChecksum': 'Ungültige USt-IdNr.-Prüfziffer.',
  'validation.vatFormatInvalid': 'Ungültiges USt-IdNr.-Format.',
  'validation.vatInvalid': 'Ungültige USt-IdNr.',
}
