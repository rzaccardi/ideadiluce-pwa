...
export const messages: Record<MessageKey, string> = {
  ...
  'nav.logout': 'Sign out',
  'nav.lights': 'Lights',
  'nav.lightsOn': 'Turn lights on',
  'nav.lightsOff': 'Turn lights off',
  ...
  'privacy.storage.title': 'Local storage (localStorage)',
  'privacy.storage.intro':
    'In addition to cookies, the Site uses HTML5 localStorage on the device for necessary or preference features. It is not used for advertising. The Cookiebot list below also includes third-party cookies and storage detected on the domain.',
  'privacy.storage.col.name': 'Name',
  'privacy.storage.col.type': 'Type',
  'privacy.storage.col.duration': 'Duration',
  'privacy.storage.col.purpose': 'Purpose',
  'privacy.storage.col.category': 'Category',
  'privacy.storage.type.localStorage': 'HTML5 Local Storage',
  'privacy.storage.duration.persistent': 'Persistent',
  'privacy.storage.duration.untilLogout': 'Until logout',
  'privacy.storage.category.necessary': 'Necessary',
  'privacy.storage.category.preferences': 'Preferences',
  'privacy.storage.cartMirror.purpose':
    'Keeps a reference to the cart (id and reservation expiry) between visits.',
  'privacy.storage.authSession.purpose': 'Keeps the account sign-in state between visits.',
  'privacy.storage.searchRecent.purpose': 'Stores recent catalogue searches for the active language.',
  'privacy.storage.lights.purpose': 'Remembers whether product photos are shown lit or unlit.',
  ...
  'productNotFound.contactTitle': 'Need help?',
  'productNotFound.contactBody':
    'Write or call us: we help you identify the product and find the right solution.',
  'productNotFound.contactCta': 'Go to contacts',
  ...
  'chiSiamo.mapAlt': 'Map / Idea di Luce headquarters',
  ...
  'catalog.emptyTitle': 'No products listed',
  'catalog.emptyDescription':
    'No results match these filters. Try advanced search or ask us for the product you need.',
  'catalog.degradedBanner':
    'Catalog is running in reduced mode: availability and prices may be outdated. You can still order.',
  'catalog.empty.searchCta': 'Advanced search',
  'catalog.empty.requestCta': 'Request a product',
  'category.loading': 'Loading…',
  'category.empty': 'No products in this category.',
  'category.backToCatalog': '← {catalog}',
  'product.notAvailable': 'Product no longer available',
  'product.degradedBanner':
    'This page is from a local cache: availability may need confirmation. You can still proceed to checkout.',
  ...
  'product.docs.title': 'Documents and technical sheets',
  'product.docs.datasheet': 'Datasheet',
  'product.docs.euSheet': 'EU product sheet',
  'product.docs.ce': 'CE declaration',
  ...
  'product.designRelated.designerEyebrow': 'THE DESIGNER',
  'product.designRelated.designerTitle': 'More designs by {name}',
  'product.designRelated.similarEyebrow': 'SIMILAR',
  'product.designRelated.similarTitle': 'More icons to discover',
  'product.designRelated.seeAll': 'See all →',
  'product.accessories.title': 'Compatible accessories',
  'product.accessories.subtitle': 'Bulbs and accessories recommended in Odoo for this product.',
  'product.accessories.compactTitle': 'Complete with accessories',
  'product.accessories.sectionHeading': 'Complete the setup',
  'product.accessories.addOn': 'Add accessory',
  'product.accessories.addWithProduct': 'Add together',
  'product.accessories.selectedCount': '{count} accessories selected',
  'product.accessories.viewProduct': 'View product',
  'product.accessories.unavailableLink': 'Product page unavailable',
  'product.accessories.includedTotal': '{count} accessories included · Total {total}',
  'product.accessories.priceIncludes': 'Product {product} + accessories {accessories}',
  'product.suggested.oosBanner': 'Out of stock. Suggested alternatives:',
  'product.suggested.title': 'You may also like',
  'product.compatibleSources.title': 'Compatible sources',
  'product.compatibleSources.subtitle': 'Products this spare part is compatible with.',
  'product.grid.empty': 'No products listed.',
  'product.card.noImage': 'No image',
  'product.price.vatIncluded': 'VAT included',
  'product.price.vatExcluded': 'VAT excluded',
  ...
  'product.meta.eanCopyAria': 'Copy EAN {ean}',
  'product.meta.eanCopyHint': 'Click to copy',
  'product.meta.eanCopied': 'Copied',
  'product.meta.eanCopyFailed': 'Could not copy the EAN code',
  'product.meta.eanBarcodeAria': 'EAN barcode {ean}',
  'product.meta.eanDownloadPng': 'Download PNG',
  'product.meta.eanDownloadPdf': 'Download PDF',
  'product.meta.eanDownloadSvg': 'Download SVG',
  'product.meta.eanDownloadFailed': 'Could not download the barcode',
  ...
  'cart.checkoutCta': 'Proceed to payment',
  'cart.remove': 'Remove',
  ...
  'walletQuickPay.openCheckout': 'Proceed to payment',
  ...
  'checkout.summary.shippingFree': 'Free',
  ...
  'checkout.shipping.freeShippingLockedHint':
    'You qualify for free shipping: you can choose free delivery or in-store pickup.',
  ...
  'checkout.shipping.savedAddressesHint': 'Choose a shipping address already linked to your account.',
  'checkout.shipping.useOtherAddress': 'Use a different address',
  ...
  'checkout.summary.trust.supportTitle': 'Real support',
  'checkout.summary.trust.supportSubtitle': 'Before and after your order',
  ...
  'checkout.loading.account': 'Creating account…',
  'checkout.loading.accountLogin': 'Retrieving account data…',
  ...
  'checkout.address.phoneOptional': 'Phone',
  ...
  'checkout.address.autofillBanner': 'Search and autofill',
  'checkout.address.autofillHint':
    'Search for an address and select it from the list — the fields below fill in automatically.',
  ...
  'checkout.review.legalAcceptanceBeforeTerms': 'By continuing you declare that you have read and accepted the',
  'checkout.review.legalTermsLink': 'terms and conditions of sale',
  'checkout.review.legalAcceptanceBetween': '. You also declare that you have read and understood the',
  'checkout.review.legalPrivacyLink': 'privacy policy',
  'checkout.review.legalAcceptanceAnd': 'and the',
  ...
  'thankYou.support.body':
    'Our team can help with wiring, compatibility and installation. Contact us anytime, even after delivery.',
  ...
  'account.addresses.description':
    'Shipping addresses on your account. Each destination is linked to a delivery contact in Odoo.',
  'account.addresses.empty': 'No saved shipping addresses.',
  'account.addresses.add': 'Add address',
  'account.addresses.addTitle': 'New shipping address',
  'account.addresses.edit': 'Edit',
  'account.addresses.editTitle': 'Edit address',
  'account.addresses.delete': 'Delete',
  'account.addresses.deleteConfirmTitle': 'Delete this address?',
  'account.addresses.deleteConfirmDescription':
    'The address will be archived in Odoo and will no longer appear at checkout.',
  'account.addresses.default': 'Default',
  'account.addresses.sedeHint':
    '“{label}” is the company HQ: edit company details in Profile. You can add more shipping addresses (Odoo child partners).',
  'account.addresses.loadError': 'Could not load addresses. Please try again.',
  ...
  'account.invoices.state.posted': 'Confirmed',
  'account.invoices.state.draft': 'Draft',
  'account.invoices.state.cancel': 'Cancelled',
  'account.invoices.payment.paid': 'Paid',
  'account.invoices.payment.unpaid': 'Unpaid',
  ...
  'orders.detail.invoicePortal': 'More details',
  'orders.return.title': 'Right of withdrawal and returns',
  'orders.return.description':
    'You can request a return within 14 days of receiving the products. The request is sent to our team: you will shortly receive instructions on the procedure to follow.',
  'orders.return.button': 'Request return',
  'orders.return.submit': 'Send return request',
  'orders.return.submitting': 'Sending…',
  'orders.return.notesLabel': 'Reason (optional)',
  'orders.return.notesPlaceholder': 'Tell us which items you want to return and, if you wish, why.',
  'orders.return.successTitle': 'Return request sent',
  'orders.return.successBody':
    'We have sent you a confirmation email. You will shortly receive instructions on the procedure to follow to complete the return.',
  'orders.return.alreadyRequested': 'Request already sent',
  'orders.return.toastSuccess': 'Return request sent. Please check your email.',
  'orders.return.toastAlready': 'You have already sent a return request for this order.',
  'orders.return.legalNote':
    'The right of withdrawal does not apply to made-to-order, customised products, or items that cannot be returned by their nature.',
  'orders.return.expired':
    'More than 14 days have passed since delivery. You can no longer start a return from this order.',
  'orders.return.expiredTitle': 'Return period expired',
  'orders.return.expiredButton': 'Period expired',
  'orders.shipment.title': 'Shipment and parcel',
  'orders.shipment.carrier': 'Carrier',
  'orders.shipment.tracking': 'Tracking',
  'orders.shipment.location': 'Last location',
  'orders.shipment.eta': 'Estimated delivery',
  'orders.shipment.deliveredAt': 'Delivered on',
  ...
  'orderStatus.shipment_exception': 'Shipment issue',
  ...
  'legacySite.notice.message':
    'You are on our new website. If something does not work or you cannot complete your order, you can continue on the previous site.',
  'legacySite.notice.cta': 'Open the previous site',
  'legacySite.checkout.hint':
    'Unable to complete your order? You can continue on the previous site while we sort this out.',
  'legacySite.footer.link': 'Having trouble with the new site? Continue on old.ideadiluce.it',
  ...
  'validation.streetNumberOrSnc': 'Enter the street number, or select “No street number”.',
  'validation.invalidPostalCode': 'Invalid postal code.',
  'validation.invalidProvince': 'Invalid province.',
  'validation.invalidPhone': 'Invalid phone number.',
  'validation.invalidCountry': 'Invalid country code.',
  'validation.required': 'This field is required.',
  'validation.tooShort': 'Value is too short.',
  'validation.tooLong': 'Value is too long.',
  'validation.invalidEmail': 'Invalid email address.',
  'validation.invalid': 'Invalid data.',
  'validation.emailRequired': 'Email is required.',
  'validation.addressesRequired': 'Billing and shipping addresses are required.',
  'validation.paymentMethodRequired': 'Payment method is required.',
  'validation.companyNameRequired': 'Company name is required.',
  'validation.companyNameRequiredBusiness': 'Company name is required for business orders.',
  'validation.vatRequired': 'VAT number is required.',
  'validation.vatRequiredBusiness': 'VAT number is required for business orders.',
  'validation.pecOrSdiRequired': 'Enter at least a PEC email or SDI recipient code.',
  'validation.fiscalCodeRequired': 'Tax code is required.',
  'validation.fiscalCodeLength': 'The tax code must be 16 characters.',
  'validation.fiscalCodeFormat': 'Invalid tax code format.',
  'validation.fiscalCodeInvalid': 'Invalid tax code.',
  'validation.vatDigits': 'The VAT number must have 11 digits.',
  'validation.vatChecksum': 'Invalid VAT checksum.',
  'validation.vatFormatInvalid': 'Invalid VAT number format.',
  'validation.vatInvalid': 'Invalid VAT number.',
  ...
  'theme.switcher.title': 'Black or dark theme',
  ...
  'account.profile.businessTitle': 'Business details',
  'account.quotes.checkout': 'Checkout',
  'checkout.frozenQuote.loading': 'Loading locked prices…',
  'checkout.frozenQuote.title': 'Quote checkout',
}
