...
const IT: Record<MessageKey, string> = {
  ...
  'common.loadingCatalog': 'Caricamento catalogo in corso…',
  ...
  'product.backToCatalog': 'Torna al catalogo',
  ...
  'product.socialProof.disabled': 'Le notifiche di attività recente non sono attive per questo catalogo.',
  ...
  'cart.empty.description': 'Aggiungi prodotti dal catalogo o torna alla home.',
  'cart.empty.browseCatalog': 'Sfoglia il catalogo',
  ...
  'wishlist.emptyDescription': 'Aggiungi prodotti ai preferiti dal catalogo.',
  ...
  'wishlist.item.notInCatalog': 'Prodotto non più nel catalogo',
  ...
  'paymentResult.catalog': 'Catalogo',
  ...
  'thankYou.crossSell.catalog': 'Vai al catalogo',
  ...
  'account.overview.browseCatalog': 'Sfoglia il catalogo',
  ...
  'account.shell.backToCatalog': 'Torna al catalogo',
  ...
  'skeleton.loadingCatalogFilters': 'Caricamento filtri catalogo',
...
const EN: Record<MessageKey, string> = {
  ...
  'catalog.metaDescription': 'Lighting catalog — lamps, wall lights, and solutions for home and professionals.',
  ...
  'product.socialProof.disabled': 'Recent activity notifications are not enabled for this catalog.',
  ...
  'cart.empty.description': 'Add products from the catalog or return to the home page.',
  'cart.empty.browseCatalog': 'Browse catalog',
  ...
  'wishlist.emptyDescription': 'Add products to your wishlist from the catalog.',
  ...
  'wishlist.item.notInCatalog': 'Product no longer in catalog',
  ...
  'thankYou.crossSell.catalog': 'Browse catalog',
  ...
  'account.overview.browseCatalog': 'Browse catalog',
  'account.overview.segmentB2b': '(B2B)',
  'account.overview.segmentB2c': '(B2C)',
  'account.overview.segmentProfessional': '(Professional)',
  ...
  'account.shell.backToCatalog': 'Back to catalog',
  ...
  'skeleton.loadingCatalogFilters': 'Loading catalog filters',
...
const ES: Record<MessageKey, string> = {
  ...
  'catalog.metaDescription': 'Catálogo de iluminación — lámparas, apliques y soluciones para el hogar y profesionales.',
  ...
  'cart.empty.browseCatalog': 'Explorar catálogo',
  ...
  'wishlist.emptyDescription': 'Añade productos a favoritos desde el catálogo.',
  ...
  'wishlist.item.notInCatalog': 'Producto ya no en el catálogo',
  ...
  'paymentResult.catalog': 'Catálogo',
  ...
  'thankYou.crossSell.catalog': 'Ir al catálogo',
  ...
  'account.overview.browseCatalog': 'Explorar catálogo',
  'account.overview.segmentB2b': '(B2B)',
  'account.overview.segmentB2c': '(B2C)',
  'account.overview.segmentProfessional': '(Professional)',
  ...
  'account.shell.backToCatalog': 'Volver al catálogo',
  ...
  'skeleton.loadingCatalogFilters': 'Cargando filtros del catálogo',
...
const FR: Record<MessageKey, string> = {
  ...
  'catalog.metaDescription': 'Catalogue d\'éclairage — lampes, appliques et solutions pour la maison et les professionnels.',
  ...
  'cart.empty.browseCatalog': 'Parcourir le catalogue',
  ...
  'wishlist.emptyDescription': 'Ajoutez des produits aux favoris depuis le catalogue.',
  ...
  'wishlist.item.notInCatalog': 'Produit retiré du catalogue',
  ...
  'paymentResult.catalog': 'Catalogue',
  ...
  'thankYou.crossSell.catalog': 'Voir le catalogue',
  ...
  'account.overview.browseCatalog': 'Parcourir le catalogue',
  'account.overview.segmentB2b': '(B2B)',
  'account.overview.segmentB2c': '(B2C)',
  'account.overview.segmentProfessional': '(Professional)',
  ...
  'account.shell.backToCatalog': 'Retour au catalogue',
  ...
  'skeleton.loadingCatalogFilters': 'Chargement des filtres catalogue',
...
const DE: Record<MessageKey, string> = {
  ...
  'common.loadingCatalog': 'Katalog wird geladen…',
  ...
  'catalog.metaDescription': 'Beleuchtungskatalog — Lampen, Wandleuchten und Lösungen für Zuhause und Profis.',
  'catalog.search': 'Produkte suchen',
  'catalog.searchLabel': 'Im Katalog suchen',
  ...
  'cart.empty.description': 'Fügen Sie Produkte aus dem Katalog hinzu oder kehren Sie zur Startseite zurück.',
  'cart.empty.browseCatalog': 'Katalog durchstöbern',
  ...
  'wishlist.emptyDescription': 'Fügen Sie Produkte aus dem Katalog zur Merkliste hinzu.',
  ...
  'wishlist.item.notInCatalog': 'Produkt nicht mehr im Katalog',
  ...
  'thankYou.crossSell.catalog': 'Zum Katalog',
  ...
  'account.overview.browseCatalog': 'Katalog durchstöbern',
  'account.overview.segmentB2b': '(B2B)',
  'account.overview.segmentB2c': '(B2C)',
  'account.overview.segmentProfessional': '(Professional)',
  ...
  'account.shell.backToCatalog': 'Zurück zum Katalog',
  ...
  'skeleton.loadingCatalogFilters': 'Katalogfilter werden geladen',
