...
export const AMBIENTI_ROOM_META: AmbientiRoomMeta[] = [
  {
    ...
    tags: [
      { label: 'Piantane', href: '/negozio?world=design&q=piantana' },
      { label: 'Applique', href: '/negozio?world=design&q=applique' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Sospensioni', href: '/negozio?world=design&q=sospensione' },
      { label: 'Faretti', href: '/negozio?world=technical&q=faretto' },
      { label: 'Strisce LED', href: '/negozio?world=technical&q=striscia+led' },
      { label: 'Sottopensili', href: '/negozio?world=technical&q=sottopensile' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique specchio', href: '/negozio?world=design&q=applique+specchio' },
      { label: 'Plafoniere IP', href: '/negozio?world=design&q=plafoniera+ip' },
      { label: 'Faretti IP65', href: '/negozio?world=technical&q=faretto+ip65' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Abat-jour', href: '/negozio?world=design&q=abat-jour' },
      { label: 'Applique', href: '/negozio?world=design&q=applique' },
      { label: 'Strisce LED', href: '/negozio?world=technical&q=striscia+led' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Lampade da tavolo', href: '/negozio?world=design&q=lampada+tavolo' },
      { label: 'Faretti', href: '/negozio?world=technical&q=faretto' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique outdoor', href: '/negozio?world=design&q=applique+outdoor' },
      { label: 'Paletti', href: '/negozio?world=design&q=paletto' },
      { label: 'Segnapasso', href: '/negozio?world=technical&q=segnapasso' },
  ...
  products: [
    {
      ...
      price: '€ 129',
      visible: true,
      href: '/negozio?world=design&q=sospensione+isola',
    },
    {
      id: 2,
      ...
      price: '€ 39',
      visible: true,
      href: '/negozio?world=technical&q=striscia+led+24v',
    },
    {
      id: 3,
      ...
      price: '€ 22',
      visible: false,
      href: '/negozio?world=technical&q=profilo+led',
    },
    {
      id: 4,
      ...
      price: '€ 42',
      visible: false,
      href: '/negozio?world=technical&q=alimentatore+24v',
    },
