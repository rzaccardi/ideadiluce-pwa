...
export const AMBIENTI_ROOM_META: AmbientiRoomMeta[] = [
  {
    ...
    tags: [
      { label: 'Piantane', href: '/negozio?world=design&tipologia=terra' },
      { label: 'Applique', href: '/negozio?world=design&tipologia=parete' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Sospensioni', href: '/negozio?world=design&tipologia=sospensione' },
      { label: 'Faretti', href: '/negozio?world=design&tipologia=incasso' },
      { label: 'Strisce LED', href: '/negozio?world=technical&category=strip' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique', href: '/negozio?world=design&tipologia=parete' },
      { label: 'Plafoniere', href: '/negozio?world=design&tipologia=plafoniere' },
      { label: 'Faretti', href: '/negozio?world=design&tipologia=incasso' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Tavolo', href: '/negozio?world=design&tipologia=tavolo' },
      { label: 'Applique', href: '/negozio?world=design&tipologia=parete' },
      { label: 'Strisce LED', href: '/negozio?world=technical&category=strip' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Lampade da tavolo', href: '/negozio?world=design&tipologia=tavolo' },
      { label: 'Faretti', href: '/negozio?world=design&tipologia=incasso' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique', href: '/negozio?world=design&tipologia=parete&stile=outdoor' },
      { label: 'Outdoor', href: '/negozio?world=design&stile=outdoor' },
      { label: 'Speciali', href: '/negozio?world=technical&category=speciali' },
      { label: 'LED', href: '/negozio?world=technical&category=led' },
    ],
...
export const AMBIENTI_SHOP_THE_LOOK = {
  ...
  products: [
    ...
    },
    {
      ...
      price: '€ 39',
      visible: true,
      href: '/negozio?world=technical&category=strip',
    },
    {
      id: 3,
      ...
      price: '€ 22',
      visible: false,
      href: '/negozio?world=technical&category=accessori',
    },
    {
      id: 4,
      ...
      price: '€ 42',
      visible: false,
      href: '/negozio?world=technical&category=driver',
    },
