...
export const AMBIENTI_ROOM_META: AmbientiRoomMeta[] = [
  {
    ...
    tags: [
      { label: 'Piantane', href: '/catalog?world=design&q=piantana' },
      { label: 'Applique', href: '/catalog?world=design&q=applique' },
      { label: 'Strisce LED', href: '/catalog?world=technical&q=striscia+led' },
  ...
  },
  {
    ...
    tags: [
      { label: 'Sospensioni', href: '/catalog?world=design&q=sospensione' },
      { label: 'Faretti', href: '/catalog?world=technical&q=faretto' },
      { label: 'Strisce LED', href: '/catalog?world=technical&q=striscia+led' },
      { label: 'Sottopensili', href: '/catalog?world=technical&q=sottopensile' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique specchio', href: '/catalog?world=design&q=applique+specchio' },
      { label: 'Plafoniere IP', href: '/catalog?world=design&q=plafoniera+ip' },
      { label: 'Faretti IP65', href: '/catalog?world=technical&q=faretto+ip65' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Abat-jour', href: '/catalog?world=design&q=abat-jour' },
      { label: 'Applique', href: '/catalog?world=design&q=applique' },
      { label: 'Strisce LED', href: '/catalog?world=technical&q=striscia+led' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Lampade da tavolo', href: '/catalog?world=design&q=lampada+tavolo' },
      { label: 'Faretti', href: '/catalog?world=technical&q=faretto' },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: 'Applique outdoor', href: '/catalog?world=design&q=applique+outdoor' },
      { label: 'Paletti', href: '/catalog?world=design&q=paletto' },
      { label: 'Segnapasso', href: '/catalog?world=technical&q=segnapasso' },
      { label: 'Proiettori', href: '/catalog?world=technical&q=proiettore' },
    ],
  ...
  products: [
    {
      ...
      price: '€ 129',
      visible: true,
      href: '/catalog?world=design&q=sospensione+isola',
    },
    {
      id: 2,
      ...
      price: '€ 39',
      visible: true,
      href: '/catalog?world=technical&q=striscia+led+24v',
    },
    {
      id: 3,
      ...
      price: '€ 22',
      visible: false,
      href: '/catalog?world=technical&q=profilo+led',
    },
    {
      id: 4,
      ...
      price: '€ 42',
      visible: false,
      href: '/catalog?world=technical&q=alimentatore+24v',
    },
