...
export const DEFAULT_DESIGN_CATEGORY_IT: CategoryLandingContent = {
  ...
  typeTiles: [
    { key: 'sospensione', label: 'Sospensione', count: '64', href: '/catalogo?world=design&q=sospensione' },
    { key: 'parete', label: 'Parete', count: '48', href: '/catalogo?world=design&q=parete' },
    { key: 'tavolo', label: 'Tavolo', count: '39', href: '/catalogo?world=design&q=tavolo' },
    { key: 'terra', label: 'Terra', count: '27', href: '/catalogo?world=design&q=terra' },
    { key: 'plafoniere', label: 'Plafoniere', count: '31', href: '/catalogo?world=design&q=plafoniere' },
    { key: 'faretti', label: 'Faretti e incassi', count: '33', href: '/catalogo?world=design&q=faretto' },
  ],
  filtersTitle: 'Filtri',
...
const TECHNICAL_BASE: Omit<CategoryLandingContent, 'breadcrumb' | 'title' | 'subtypeChips'> = {
  ...
  cta: {
    ...
    secondaryCta: { label: 'Cerca per EAN', href: '/catalogo?world=technical' },
  },
...
export const DEFAULT_TECHNICAL_CATEGORY_IT: CategoryLandingContent = {
  ...
  subtypeChips: [
    ...
    { label: 'Lampadine', href: '/catalogo?world=technical&q=lampadina' },
    ...
    { label: 'Accessori', href: '/catalogo?world=technical&q=accessori' },
  ],
}
...
export const DEFAULT_TECHNICAL_PRODUCTS_CATEGORY_IT: CategoryLandingContent = {
  ...
  subtypeChips: [
    ...
    { label: 'Starter', href: '/catalogo?world=technical&q=starter' },
