  ...
  filterGroups: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'PHILIPS', value: 'brand-philips' },
        { label: 'GENERAL ELECTRIC', value: 'brand-general-electric' },
        { label: 'SYLVANIA', value: 'brand-sylvania' },
        { label: 'SPL', value: 'brand-spl' },
        { label: 'VOSSLOH', value: 'brand-vossloh' },
        { label: 'LEDVANCE', value: 'brand-ledvance' },
        { label: 'AIGOSTAR', value: 'brand-aigostar' },
        { label: 'PATRON', value: 'brand-patron' },
        { label: 'ILESA', value: 'brand-ilesa' },
        { label: 'DURALAMP', value: 'brand-duralamp' },
        { label: 'CENTURY', value: 'brand-century' },
        { label: 'THORGEON', value: 'brand-thorgeon' },
        { label: 'TCI', value: 'brand-tci' },
        { label: 'GENELUX', value: 'brand-genelux' },
      ],
    },
    {
      kind: 'chips',
...
export const DEFAULT_TECHNICAL_CATEGORY_IT: CategoryLandingContent = {
  ...
  subtypeChips: [
    ...
    { label: 'LED', href: '/negozio?world=technical&category=led' },
    { label: 'Driver', href: '/negozio?world=technical&category=driver' },
    { label: 'Ballast', href: '/negozio?world=technical&category=ballast' },
    { label: 'Accessori', href: '/negozio?world=technical&category=accessori' },
  ],
}
...
export const DEFAULT_TECHNICAL_PRODUCTS_CATEGORY_IT: CategoryLandingContent = {
  ...
  description:
    'Driver, ballast, portalampade, accenditori e accessori dal catalogo Odoo live. Ogni voce punta a una categoria o tag reale.',
  subtypeChips: [
    { label: 'Tutti', href: '/categoria-prodotto/illuminazione-tecnica' },
    { label: 'Driver', href: '/negozio?world=technical&category=driver', active: true },
    { label: 'Ballast', href: '/negozio?world=technical&category=ballast' },
    { label: 'Portalampade', href: '/negozio?world=technical&tag=portalampade' },
    { label: 'Accenditori', href: '/negozio?world=technical&category=accenditori' },
    { label: 'Accessori', href: '/negozio?world=technical&category=accessori' },
    { label: 'Strisce LED', href: '/negozio?world=technical&category=strip' },
  ],
}
