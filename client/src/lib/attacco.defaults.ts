...
export const ATTACCO_SHAPES: AttaccoShape[] = [
  { label: 'Goccia', code: 'A60', href: '/negozio?world=technical&q=A60', icon: 'goccia' },
  { label: 'Sfera', code: 'G45', href: '/negozio?world=technical&q=G45', icon: 'sfera' },
  { label: 'Candela', code: 'C35', href: '/negozio?world=technical&q=C35', icon: 'candela' },
  { label: 'Tubolare', code: 'T', href: '/negozio?world=technical&q=tubolare', icon: 'tubolare' },
  { label: 'Riflettore', code: 'R63', href: '/negozio?world=technical&q=R63', icon: 'riflettore' },
  { label: 'Globo', code: 'G95', href: '/negozio?world=technical&q=G95', icon: 'globo' },
  { label: 'Spot', code: 'MR16', href: '/negozio?world=technical&q=MR16', icon: 'spot' },
  { label: 'Lineare', code: 'R7s', href: attaccoHref('r7s'), icon: 'lineare' },
  { label: 'Filamento', code: 'ST64', href: '/negozio?world=technical&q=ST64', icon: 'filamento' },
  {
