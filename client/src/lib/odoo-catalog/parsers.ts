import type { ProductAvailabilityDataDTO, ProductDocumentDTO } from '@/types/dto'
import { odooCatalogProductDocCurrentUrl, resolveOdooCatalogMediaUrl } from './media'

type OdooCatalogAvailabilityFlat = {
...
function mergeAvailabilityRecord(
  raw: unknown,
  flat?: OdooCatalogAvailabilityFlat,
...
export function parseOdooCatalogAvailability(
  raw: unknown,
  flat?: OdooCatalogAvailabilityFlat,
...
export function parseOdooCatalogDocuments(
  raw: unknown,
  options?: { ced?: string | null },
): ProductDocumentDTO[] {
