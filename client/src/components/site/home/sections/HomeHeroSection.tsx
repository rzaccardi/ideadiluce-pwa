    ...
    <div className="grid border-b border-idl-border lg:grid-cols-2">
      <FadeIn className="relative overflow-hidden bg-idl-design px-6 py-10 text-idl-design-fg sm:px-12 sm:py-16 lg:px-16 lg:py-[74px]">
        ...
        <section aria-labelledby="home-hero-design-title" className="relative z-[2] max-w-lg lg:ml-auto">
          ...
          <h1
            id="home-hero-design-title"
            className="mt-5 font-serif text-[31px] leading-[1.07] font-medium tracking-tight sm:text-[44px]"
          >
            {design.title}
          </h1>
      ...
      >
        <section aria-labelledby="home-hero-technical-title">
          <Eyebrow variant="technical">{technical.eyebrow}</Eyebrow>
          <h2
            id="home-hero-technical-title"
            className="mt-5 text-[28px] leading-[1.05] font-extrabold tracking-tight sm:text-[43px]"
          >
            {technical.title}
          </h2>
