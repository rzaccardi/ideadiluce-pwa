...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden className={cn('h-7 w-7', className)} fill="currentColor">
  ...
  return (
    <div className="pointer-events-none fixed bottom-5 right-4 z-40 flex justify-end sm:right-5">
      <a
        ...
        className={cn(
          'pointer-events-auto inline-flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg shadow-zinc-950/20',
          'transition hover:brightness-105 hover:shadow-xl',
