      ...
      <SectionContainer narrow className="py-10 text-center">
        ...
        <form className="mx-auto mt-5 flex max-w-md flex-col gap-2 sm:flex-row" onSubmit={(e) => e.preventDefault()}>
          <input
            ...
            className="min-w-0 flex-1 rounded-md border border-idl-border bg-idl-white px-4 py-3 text-sm text-idl-ink outline-none placeholder:text-idl-placeholder dark:bg-white/10"
          />
