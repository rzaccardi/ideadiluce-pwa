...
function SospensioneIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="40" cy="52" r="16" fill="#0c0c0d" opacity="0.14" stroke="none" />
      <path d="M14 12 H66" />
      <path d="M40 12 V30" />
...
function PareteIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="44" cy="40" r="14" fill="#0c0c0d" opacity="0.14" stroke="none" />
      <path d="M18 12 V68" />
      <path d="M18 40 H28" />
...
function TavoloIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="40" cy="34" r="15" fill="#0c0c0d" opacity="0.14" stroke="none" />
...
function TerraIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="43" cy="36" r="12" fill="#0c0c0d" opacity="0.14" stroke="none" />
...
function PlafoniereIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="40" cy="26" r="14" fill="#0c0c0d" opacity="0.14" stroke="none" />
      <path d="M14 16 H66" />
...
function FarettiIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="40" cy="48" r="15" fill="#0c0c0d" opacity="0.14" stroke="none" />
      <path d="M14 16 H66" />
