  ...
  return (
    <div className="rounded-[14px] border border-idl-promo-border bg-idl-promo-bg p-5">
      ...
      <Link
        ...
        className="mt-3.5 inline-block rounded-lg border border-[#e4e4e7] bg-idl-tech-panel px-4 py-2.5 text-[13px] font-bold text-idl-graphite transition hover:border-idl-border-strong"
      >
