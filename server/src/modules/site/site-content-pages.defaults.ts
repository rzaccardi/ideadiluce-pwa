...
export const CONTENT_PAGE_DEFAULTS: Record<ContentPageKey, ContentPageContent> = {
  ...
  showroom: {
    ...
    blocks: [
      ...
      { kind: 'contact', ...COMPANY_CONTACT },
      {
        ...
        secondaryLabel: 'Vai al catalogo',
  ...
  'guide-luce-calda-naturale-fredda': {
    ...
    blocks: [
      ...
      },
      {
        ...
        primaryLabel: 'Vai al catalogo tecnico →',
        primaryHref: '/catalogo?world=technical&q=2700K',
        variant: 'accent',
      },
    ],
  },
  ...
  'guide-gu10-gu53': {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { title: 'GU10', description: '230V bispina', href: '/catalogo?world=technical&q=GU10' },
          { title: 'GU5.3', description: '12V MR16', href: '/catalogo?world=technical&q=GU5.3' },
        ],
      },
    ],
  },
  ...
  'guide-lampadina-r7s': {
    ...
    blocks: [
      ...
      {
        kind: 'cta',
        title: 'Cerca R7s nel catalogo',
        primaryLabel: 'Vedi prodotti R7s →',
        primaryHref: '/catalogo?world=technical&q=R7s',
        variant: 'accent',
      },
    ],
  },
  ...
  'guide-illuminare-soggiorno': {
    ...
    blocks: [
      ...
      },
      {
        ...
        primaryHref: '/catalogo?world=design&category=soggiorno',
        variant: 'accent',
      },
    ],
  },
  ...
  'guide-alimentatore-striscia-led': {
    ...
    blocks: [
      ...
      {
        kind: 'cta',
        title: 'Alimentatori nel catalogo',
        primaryLabel: 'Alimentatori e driver →',
        primaryHref: '/catalogo?world=technical&q=alimentatore',
        variant: 'accent',
      },
    ],
  },
