...
export const SITE_PAGE_LABELS: Record<SitePageKey, string> = {
  ...
  'guide-luce-calda-o-fredda': 'Articolo: luce calda o fredda',
  'guide-calipso-artemide-io-vengo-dalla-luna': 'Articolo: Calipso Artemide',
  'guide-la-natura-trend-2024': 'Articolo: trend natura 2024',
